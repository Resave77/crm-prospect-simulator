...
func New(cfg config.Config, authService *service.AuthService, prospectService *prospectservice.Service, customerService *customerservice.Service, adminService *adminservice.Service, extras ...any) *fiber.App {
	...
	admin.Get("/prospects/trash", prospectHandler.TrashedProspects)
	...
	admin.Get("/prospect-finder/place-details", prospectHandler.PlaceFinderPlaceDetails)
	...
	admin.Patch("/prospects/:id/assignment", prospectHandler.Assign)
	admin.Delete("/prospects/:id", prospectHandler.DeleteProspect)
	admin.Post("/prospects/:id/trash", prospectHandler.TrashProspect)
	admin.Post("/prospects/:id/restore", prospectHandler.RestoreProspect)
	...
	admin.Get("/visits/trash", prospectHandler.ListTrashedVisits)
	admin.Post("/visits/:visitId/restore", prospectHandler.RestoreVisit)
	...
	admin.Delete("/customers/trash", customerHandler.ClearTrashedCustomers)
