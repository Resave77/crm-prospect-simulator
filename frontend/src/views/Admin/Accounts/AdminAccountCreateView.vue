...
const passwordWasAutoGenerated = ref(true)
...
const requiredFields = computed(() => [
  ...
  { label: 'Employee Name', complete: Boolean(form.name.trim()) },
  ...
  { label: 'Password', complete: form.temporaryPassword.length >= 8 },
])
...
watch(
  ...
  (email) => {
    ...
    if (passwordWasAutoGenerated.value || !form.temporaryPassword.trim()) {
      form.temporaryPassword = generateTemporaryPassword(email)
      passwordWasAutoGenerated.value = true
    }
  },
)
...
function generateTemporaryPassword(seed = '') {
  const base = seed
    .split('@')[0]
    ?.replace(/[^a-zA-Z0-9]/g, '')
    .slice(0, 6) || 'Employee'
  const random = Math.random().toString(36).slice(2, 8)
  return `Yummy@${base}${random}`
}

function markPasswordManual() {
  passwordWasAutoGenerated.value = false
}

const previewTimezone = computed(() => timezoneOptions.find((item) => item.value === form.timezone)?.label.split(' â€” ').pop() || form.timezone || 'Not set')
...
function clearAvatar(event?: Event) {
  event?.stopPropagation()
  avatarPreview.value = ''
  avatarFileName.value = ''
  const input = document.querySelector('.avatar-drop input[type="file"]') as HTMLInputElement | null
...
async function handleSubmit() {
  if (!form.temporaryPassword.trim()) {
    form.temporaryPassword = generateTemporaryPassword(form.email)
    passwordWasAutoGenerated.value = true
  }
    ...
    <div class="content-layout">
      <main class="form-column">
          ...
          <div class="form-grid">
            <div class="form-field">
              ...
              <InputText
                ...
                autocomplete="name"
              />
              <small>Use the employee's full legal or display name.</small>
            </div>
            ...
            <div class="form-field">
              ...
              <InputText
                ...
                autocomplete="email"
              />
              <small>This email will be used for CRM login access.</small>
            </div>
            ...
            <div class="form-field">
              ...
              <Password
                ...
                placeholder="Generated after email is filled"
                inputClass="full-input"
                @input="markPasswordManual"
              />
              <small>Generated automatically from the email address, but you can edit it.</small>
            </div>
        ...
        <section class="form-section additional-section">
          ...
          <template v-if="additionalDetailsOpen">
      ...
      <aside class="sidebar-column">
        ...
        <section class="help-card">
          ...
          <div>
            ...
            <p>
              Fill Employee Name, Email, Password, and Account Type.
