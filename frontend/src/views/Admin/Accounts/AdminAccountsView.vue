  ...
  <section class="accounts-page">
    ...
    <header class="accounts-toolbar">
      ...
      <div class="toolbar-controls">
        ...
        <Button label="More Filters" icon="pi pi-sliders-h" severity="secondary" outlined size="small" class="filter-toggle-button" @click="showFilters = !showFilters" />
    ...
    <AdminTableShell class="table-shell">
      <div class="accounts-pagination-top">
        <div class="accounts-page-links">
          <Button icon="pi pi-angle-left" text rounded size="small" aria-label="Previous page" :disabled="store.page <= 1" @click="selectPage(store.page - 1)" />
          <Button
          ...
          />
          <Button icon="pi pi-angle-right" text rounded size="small" aria-label="Next page" :disabled="store.page >= (store.pages || 1)" @click="selectPage(store.page + 1)" />
        ...
        <div class="accounts-page-settings">
          <label class="page-size-control"><span>Page size</span><Select v-model="selectedPageSize" :options="[10, 20, 50]" /></label>
          <label><span>Go to</span><InputNumber v-model="goToPage" :min="1" :max="Math.max(store.pages, 1)" /></label>
          <Button label="Set" outlined size="small" @click="goToSelectedPage" />
          <Button icon="pi pi-refresh" text rounded size="small" aria-label="Refresh employee data" title="Refresh employee data" @click="load" />
        </div>
      </div>
...
.accounts-page>.admin-page-header{display:none}.accounts-page .accounts-toolbar{gap:10px;padding:14px 24px}.accounts-page .employee-search{flex:0 1 360px;max-width:360px}.accounts-page .toolbar-controls{flex:1;gap:10px}.accounts-page .toolbar-inline-filter{width:190px}.accounts-page .toolbar-inline-filter :deep(.p-select-label){padding:0 12px;color:#64748b}.accounts-page .toolbar-controls .trash-button{margin-left:auto}.accounts-page .toolbar-controls .create-button{min-width:160px;background:#dc2626;border-color:#dc2626}@media(max-width:900px){.accounts-page .toolbar-inline-filter{flex:1;min-width:150px}}@media(max-width:640px){.accounts-page .accounts-toolbar{padding:10px 12px}.accounts-page .employee-search{max-width:none}.accounts-page .toolbar-inline-filter{width:100%;flex-basis:100%}.accounts-page .toolbar-controls .trash-button{margin-left:0}}.accounts-page .accounts-pagination-top{display:flex;align-items:center;justify-content:space-between;min-height:42px;height:42px;padding:0 20px;border-bottom:1px solid #e2e8f0;background:#fff;font-family:Inter,ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#64748b}.accounts-page .accounts-page-links{display:flex;align-items:center;gap:4px}.accounts-page .accounts-page-links :deep(.p-button){display:inline-flex;align-items:center;justify-content:center;min-width:30px;height:30px;padding:0;border:0;border-radius:999px;background:transparent;color:#475569;font-family:inherit;font-size:12px}.accounts-page .accounts-page-links :deep(.p-button:hover:not(:disabled)),.accounts-page .accounts-page-links :deep(.accounts-page-link.active){background:#fff1f2;color:#991b1b}.accounts-page .accounts-page-report{margin-left:8px;font-family:inherit;font-size:12px}.accounts-page .accounts-page-settings{display:flex;align-items:center;gap:10px;font-family:inherit}.accounts-page .accounts-page-settings label{position:relative;display:flex;align-items:center;width:80px;height:34px;padding:0 10px;border:1px solid #e2e8f0;border-radius:8px;color:#334155;font-size:11px}.accounts-page .accounts-page-settings label>span{position:absolute;top:-7px;left:8px;padding:0 4px;background:#fff;color:#475569;font-size:10px;font-weight:600}.accounts-page .accounts-page-settings :deep(.p-select),.accounts-page .accounts-page-settings :deep(.p-inputnumber){width:100%;border:0}.accounts-page .accounts-page-settings :deep(.p-select-label),.accounts-page .accounts-page-settings :deep(.p-inputnumber-input){width:100%;height:30px;padding:4px 0;border:0;background:transparent;font-family:inherit;font-size:11px}.accounts-page .accounts-page-settings :deep(.p-button){height:34px;min-width:0;padding:0 12px;border:1px solid #e2e8f0;border-radius:8px;background:#fff;color:#475569;font-family:inherit;font-size:11px}.accounts-page .accounts-page-settings :deep(.p-button:last-child){width:30px;padding:0;border:0;border-radius:999px}
.accounts-page .accounts-page-settings label:first-child{width:80px;min-width:80px}.accounts-page .accounts-page-settings label:nth-child(2){width:65px;min-width:65px}.accounts-page .accounts-page-settings label>span{white-space:nowrap}.accounts-page .accounts-page-settings :deep(.p-inputnumber-input){text-align:left}
.accounts-page .accounts-pagination-top{overflow:visible}.accounts-page .accounts-page-settings label{overflow:visible;z-index:1;background:#fff}.accounts-page .accounts-page-settings label>span{z-index:3;line-height:14px;white-space:nowrap}.accounts-page .accounts-page-settings label:first-child{width:90px;min-width:90px}.accounts-page .accounts-page-settings label:nth-child(2){width:65px;min-width:65px}.accounts-page .accounts-page-settings :deep(.p-select){overflow:visible;background:#fff}.accounts-page .accounts-page-settings :deep(.p-select-label){overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.accounts-page .toolbar-inline-filter{height:40px!important;min-height:40px!important;border:1px solid #e2e8f0!important;border-radius:10px!important;background:#fff!important;font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:12px!important;color:#64748b!important;box-shadow:none!important}.accounts-page .toolbar-inline-filter :deep(.p-select-label){display:flex;align-items:center;height:38px;padding:0 12px!important;color:#94a3b8!important;font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:12px!important;font-weight:500!important}.accounts-page .toolbar-inline-filter :deep(.p-select-dropdown){width:34px;color:#94a3b8}.accounts-page .toolbar-inline-filter:hover{border-color:#cbd5e1!important}.accounts-page .toolbar-inline-filter:focus,.accounts-page .toolbar-inline-filter.p-focus{border-color:#cbd5e1!important;box-shadow:0 0 0 3px rgba(148,163,184,.1)!important}
.accounts-page .accounts-toolbar .filter-toggle-button{height:40px!important;min-height:40px!important;display:inline-flex!important;align-items:center!important;gap:8px!important;padding:0 14px!important;border:1px solid #e2e8f0!important;border-radius:10px!important;background:#fff!important;color:#475569!important;font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:12px!important;font-weight:600!important;box-shadow:none!important}.accounts-page .accounts-toolbar .filter-toggle-button:hover{border-color:#cbd5e1!important;background:#f8fafc!important}.accounts-page .accounts-toolbar .filter-toggle-button .p-button-icon{font-size:15px!important;color:#64748b!important}.accounts-page .accounts-toolbar .filter-toggle-button .p-button-label{font-family:inherit!important;font-size:12px!important;font-weight:600!important}
.accounts-page .accounts-page-settings{height:42px;align-items:center;gap:10px}.accounts-page .accounts-page-settings label{box-sizing:border-box;height:34px!important;min-height:34px!important;margin:0;padding:0 10px!important;align-items:center!important;background:#fff!important}.accounts-page .accounts-page-settings label>span{top:-8px!important;left:8px!important;padding:0 4px!important;background:#fff!important;font-size:10px!important;line-height:14px!important}.accounts-page .accounts-page-settings label:first-child{width:80px!important;min-width:80px!important}.accounts-page .accounts-page-settings label:nth-child(2){width:65px!important;min-width:65px!important}.accounts-page .accounts-page-settings :deep(.p-select),.accounts-page .accounts-page-settings :deep(.p-inputnumber){height:30px!important;min-height:30px!important}.accounts-page .accounts-page-settings :deep(.p-select-label){height:30px!important;padding:4px 0!important;line-height:22px!important}.accounts-page .accounts-page-settings :deep(.p-inputnumber-input){height:30px!important;padding:4px 0!important;line-height:22px!important}.accounts-page .accounts-page-settings> :deep(.p-button){height:34px!important;min-height:34px!important;margin:0!important;padding:0 12px!important;border:1px solid #e2e8f0!important;border-radius:8px!important;background:#fff!important;font-size:11px!important}.accounts-page .accounts-page-settings> :deep(.p-button:last-child){width:30px!important;padding:0!important;border:0!important;border-radius:999px!important}
...
@media(max-width:800px){.accounts-page .accounts-toolbar{flex-wrap:wrap}.accounts-page .employee-search{width:100%;min-width:0;flex-basis:100%;max-width:none}.accounts-page .toolbar-controls{width:100%;flex-wrap:wrap}.accounts-page .toolbar-inline-filter{flex:1 1 150px}.accounts-page .toolbar-controls .trash-button{margin-left:auto}}
 .accounts-page .accounts-table :deep(.p-datatable-thead > tr > th){height:49px;padding:0 12px;border-right:1px solid #e2e2e2;border-bottom:1px solid #e0e0e0;background:#f4f4f4;color:#000;font-size:10px;font-weight:600;letter-spacing:.07em;text-transform:uppercase}.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td){height:84px;padding:10px 12px;border-right:1px solid #e2e8f0;border-bottom:1px solid #e0e0e0;font-size:12px}.accounts-page .accounts-table :deep(.p-datatable-tbody > tr:hover > td){background:#fff}
.accounts-page .accounts-toolbar .trash-button{height:auto!important;min-height:0!important;display:inline-flex!important;align-items:center!important;gap:8px!important;padding:10px 14px!important;border:1px solid #e2e8f0!important;border-radius:10px!important;background:#fff!important;color:#475569!important;font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:13px!important;font-weight:600!important;line-height:18px!important;box-shadow:none!important}.accounts-page .accounts-toolbar .trash-button:hover{border-color:#cbd5e1!important;background:#f8fafc!important;color:#475569!important}.accounts-page .accounts-toolbar .trash-button :deep(.p-button-icon){margin:0!important;color:#475569!important;font-size:15px!important}.accounts-page .accounts-toolbar .trash-button :deep(.p-button-label){font-family:inherit!important;font-size:13px!important;font-weight:600!important}
.accounts-page .accounts-toolbar .create-button{height:36px!important;min-height:36px!important;width:auto!important;min-width:160px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;padding:0 12px!important;border:0!important;border-radius:10px!important;background:#dc2626!important;color:#fff!important;font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-size:12px!important;font-weight:600!important;line-height:18px!important;box-shadow:none!important}.accounts-page .accounts-toolbar .create-button:hover{background:#b91c1c!important;color:#fff!important}.accounts-page .accounts-toolbar .create-button :deep(.p-button-icon){margin:0!important;color:#fff!important;font-size:15px!important}.accounts-page .accounts-toolbar .create-button :deep(.p-button-label){font-family:inherit!important;font-size:12px!important;font-weight:600!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td){padding:7px 10px!important}
.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td){height:60px!important;line-height:16px!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:first-child),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:first-child){width:46px!important;min-width:46px!important;padding:0!important;text-align:center}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(2)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(2)){width:21%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(3)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(3)){width:20%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(4)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(4)){width:14%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(5)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(5)){width:12%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(6)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(6)){width:15%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(7)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(7)){width:9%!important}
.accounts-page .accounts-table :deep(.p-datatable-thead > tr > th:nth-child(8)),.accounts-page .accounts-table :deep(.p-datatable-tbody > tr > td:nth-child(8)){width:12%!important}
</style>
