...
.visit-trash-list{display:flex;flex-direction:column;gap:10px;padding:2px 0 4px}.visit-trash-list .trash-intro{margin:0 0 4px;color:#64748b;font-size:12px}.visit-trash-row{display:flex;align-items:center;justify-content:space-between;gap:16px;width:100%;padding:12px 14px;border:1px solid #e2e8f0;border-radius:14px;background:#f8fafc;text-align:left}.visit-trash-row>div{min-width:0;flex:1}.visit-trash-row strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#172033;font-size:13px;font-weight:700}.visit-trash-row small{display:block;margin-top:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#64748b;font-size:11px;line-height:17px}.visit-trash-row :deep(.p-button){flex-shrink:0;min-width:92px;border-radius:9px;font-size:12px;font-weight:600}
</style>
