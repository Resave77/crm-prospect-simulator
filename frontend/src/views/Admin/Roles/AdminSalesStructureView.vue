...
.banner-panel { display: flex; gap: 0.9rem; align-items: flex-start; padding: 0.9rem 1.1rem; background: #fff0f1; border: 1px solid #f4b3ba; border-radius: 12px; }
.banner-icon { width: 34px; height: 34px; flex: 0 0 auto; display: grid; place-content: center; border-radius: 10px; background: #ffd9dc; color: #e63946; }
.banner-content { display: grid; gap: 0.35rem; flex: 1; min-width: 0; }
.banner-content strong { color: #d62839; font-size: 0.9rem; }
.banner-steps { margin: 0; padding-left: 1.1rem; display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 0.3rem 0.8rem; color: #d62839; font-size: 0.78rem; line-height: 1.45; }
.banner-steps li::marker { color: #e63946; }
...
.summary-card:hover { border-color: #f4b3ba; background: #fbfdff; }
...
.drawer-avatar { width: 2.45rem; height: 2.45rem; display: grid; place-content: center; border-radius: 999px; background: #fff0f1; color: #d62839; font-weight: 850; }
