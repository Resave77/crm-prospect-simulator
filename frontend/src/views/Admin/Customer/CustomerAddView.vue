      ...
      <header class="create-customer-header sticky top-0 z-40 border-b border-[#e2e8f0] bg-white/95 px-[16px] py-[9px] shadow-[0px_2px_8px_0px_rgba(15,23,42,0.04)] backdrop-blur sm:px-[24px]">
        <div class="create-customer-header-inner mx-auto flex max-w-[1180px] flex-wrap items-center justify-between gap-[12px]">
          <div class="min-w-0 flex items-center gap-[12px]">
            ...
            <div class="min-w-0">
              <h1 class="truncate font-['Inter'] text-[17px] font-bold leading-[22px] text-[#0f172a]">Create New Customer</h1>
              <p class="truncate font-['Inter'] text-[11px] leading-[15px] text-[#94a3b8]">Customer Management &gt; Customer Site &gt; Create</p>
            </div>
          </div>
          <div class="flex items-center gap-[8px]">
            ...
            >
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send size-[14px]"><path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"></path><path d="m21.854 2.147-10.94 10.939"></path></svg>Create Customer
            </button>
          </div>
        </div>
      </header>
      ...
      <div class="form-layout">
        ...
        <div class="form-stack">
          <div class="create-form-heading mb-[18px]">
            <h2 class="font-['Inter'] text-[24px] font-bold tracking-tight text-[#0f172a]">Create New Customer</h2>
        ...
        <aside class="form-sidebar">
          ...
          <div class="sidebar-actions">
            <Button label="Create Customer" icon="pi pi-check" class="full-width sidebar-create-button" :loading="saving" :disabled="!isFormValid || saving" @click="handleSubmit" />
