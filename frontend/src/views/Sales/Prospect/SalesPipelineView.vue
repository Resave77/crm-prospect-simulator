...
<template>
  <section class="mobile-page pipeline-page">
    <RouterLink class="back-link" to="/sales/dashboard"><i class="pi pi-arrow-left" /> Dashboard</RouterLink>
    <div class="mobile-title"><div><p class="eyebrow">Track assigned prospects by stage</p><h1>Sales Pipeline</h1></div><Tag :value="`${prospects.length} total`" severity="info" /></div>
...
<style scoped>
.back-link { display: inline-flex; align-items: center; gap: 0.35rem; color: #2563eb; font-size: 0.75rem; font-weight: 600; text-decoration: none; margin-bottom: 0.25rem; transition: opacity 0.15s ease; }
