  ...
  routes: [
    ...
    { path: '/forbidden', name: 'Forbidden', component: () => import('../views/NotFoundView.vue'), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'customers/add/site', name: 'AdminCustomerAddSite', component: () => import('../views/Admin/Customer/CustomerAddView.vue'), meta: { permission: 'create_customer' } },
        { path: 'customers/add/company', name: 'AdminCustomerAddCompany', component: () => import('../views/Admin/Company/CompanyAddView.vue'), meta: { permission: 'create_customer' } },
        ...
        { path: 'companies/:id', name: 'AdminCompanyDetail', component: () => import('../views/Admin/Company/CompanyDetailView.vue'), meta: { permission: 'view_customers', title: 'Company Detail', description: 'View company information, tax data, address, contacts, customer sites, and company ownership.' } },
        ...
        { path: 'prospect-assignment', name: 'AdminProspectAssignment', component: () => import('../views/Admin/Prospect/ProspectAssignmentView.vue'), meta: { permission: 'view_prospect_pipeline' } },
