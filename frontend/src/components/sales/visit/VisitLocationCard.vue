...
.vlm-marker-target { background: #e63946; }
...
.vlm-dot-target { background: #e63946; }
.vlm-dot-sales { background: #dc2626; }
.vlm-ring { width: 8px; height: 8px; border-radius: 50%; border: 1.5px dashed #e63946; flex-shrink: 0; }
</style>
