...
.dialog-form{gap:20px;max-height:min(70vh,700px);padding:4px 4px 4px 0}.assign-section{gap:8px;padding:0}.assign-section-title{font-size:13px;font-weight:700;letter-spacing:.01em}.assign-step{width:24px;height:24px;background:#e6f0ff;color:#2563eb;font-size:11px}.assign-section> :deep(.p-select),.form-field input[type='month']{min-height:48px;height:48px;border:1px solid #d6e0ec;border-radius:14px;font-size:13px}.assign-section> :deep(.p-select-label){padding:0 14px;line-height:46px}.section-note{font-size:11px;color:#64748b}.parent-info{padding:10px 12px;border-color:#dbeafe;border-radius:12px;background:#f8fbff;color:#64748b;font-size:12px}.preview-card{gap:10px;padding:14px 16px;border-color:#dbeafe;border-radius:14px;background:#f8fbff}.preview-row span{font-size:10px;font-weight:600;letter-spacing:.04em}.preview-row strong{font-size:12px}.user-option,.role-option{padding:6px 2px}.user-option-name,.role-option-name{font-size:12px;font-weight:600}.user-option-sub,.role-option-desc{font-size:11px}.picker-footer{padding:8px 10px}.dialog-form :deep(.p-message){border-radius:10px;font-size:12px}.dialog-form :deep(.p-select-label){color:#64748b}.dialog-form :deep(.p-select-overlay){border-radius:12px}.dialog-form + *{}.assign-section-title + :deep(.p-select){width:100%}:deep(.p-dialog){border:1px solid #e2e8f0;border-radius:20px;box-shadow:0 20px 50px rgba(15,23,42,.14);overflow:hidden}:deep(.p-dialog-header){padding:20px 24px;border-bottom:1px solid #e8edf3;font-size:17px;font-weight:700}:deep(.p-dialog-content){padding:20px 24px 8px}:deep(.p-dialog-footer){padding:12px 24px 20px;border-top:1px solid #e8edf3}:deep(.p-dialog-footer .p-button){height:40px;min-height:40px;border-radius:10px;padding:0 14px;font-size:12px;font-weight:600}:deep(.p-dialog-footer .p-button:last-child){background:#dc2626;border-color:#dc2626}
</style>
