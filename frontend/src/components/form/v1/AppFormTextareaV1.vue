...
<template>
  <label class="flex flex-col gap-[8px]">
    ...
    <textarea
      ...
      :disabled="disabled"
      :readonly="readonly"
      class="min-h-[96px] rounded-[14px] border bg-white px-[14px] py-[12px] text-[12px] font-medium text-[#0f172a] shadow-[0px_1px_2px_0px_rgba(15,23,42,0.04)] outline-none transition-all placeholder:text-[#94a3b8] focus:ring-2 disabled:cursor-not-allowed disabled:bg-[#f1f5f9] disabled:text-[#64748b]"
      :class="
        error
